...
//	private static final String LOG_TAG = "EditNoteActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mNoteType == Const.INVALID_INT && savedInstanceState != null) {
			// create new note
...
//				((HoloNoteCursorAdapter) this.getListAdapter()).changeCursor(noteCursor);
...
//	    		this.setListAdapter(new HoloNoteCursorAdapter(this, R.layout.edit_checklist_row, listCursor, 
